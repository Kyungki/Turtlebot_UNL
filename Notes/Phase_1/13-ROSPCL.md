...
1. Copy your [example *roscpp_hello_world.cpp* code](/Setup/catkin_ws/src/turtlebot_houston/src/roscpp_hello_world.cpp) to *roscpp_pcl.cpp*:
    1. `cp ~/catkin_ws/src/turtlebot_houston/src/roscpp_hello_world.cpp ~/catkin_ws/src/turtlebot_houston/src/roscpp_pcl.cpp`
    2. `gedit ~/catkin_ws/src/turtlebot_houston/src/roscpp_pcl.cpp`
...
3. Edit *roscpp_pcl_example.cpp* in your *src* folder
    1. `gedit ~/catkin_ws/src/turtlebot_houston/src/roscpp_pcl_example.cpp`
...
4. Build and run your new code:
    ...
    3. `rosrun turtlebot_houston roscpp_pcl_example`

## First Example Complete
* [~/catkin_ws/src/turtlebot_houston/src/roscpp_pcl_example.cpp](/Setup/catkin_ws/src/turtlebot_houston/src/roscpp_pcl_example.cpp)
